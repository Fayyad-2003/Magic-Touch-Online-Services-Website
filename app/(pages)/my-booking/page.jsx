                ...
                <Tabs defaultValue="booked" className="w-full text-primary">
                    ...
                    <div className="w-full flex justify-between md:items-center flex-col md:flex-row mb-6">
                        ...
                        {!error && 
                            ...
                            <TabsTrigger value='booked' className='text-light-blue-color cursor-pointer [&[data-state=active]]:text-primary [&[data-state=active]]:shadow-sm [&[data-state=active]]:shadow-primary/50'>
                                Booked
                            </TabsTrigger>
                            <TabsTrigger value='completed' className='text-light-blue-color cursor-pointer [&[data-state=active]]:text-primary [&[data-state=active]]:shadow-sm [&[data-state=active]]:shadow-primary/50'>
                                Completed
                            </TabsTrigger>
                        </TabsList>
                            </div>
