  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "absolute flex w-1/2 justify-between gap-24",
        button_previous: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent disabled:hidden p-0 opacity-50 hover:opacity-100 -translate-x-4 cursor-pointer",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 md:mx-[1px] font-normal aria-selected:opacity-100 cursor-pointer hover:bg-primary/50"
        ),
